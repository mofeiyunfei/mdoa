...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
    ...
    <span style="float:right; padding-right:20px;" class="head">欢迎 ${user.username }  <a href="#" id="editpass">修改密码</a> <a href="login_loginOut.action" id="loginOut">安全退出</a></span>
    <span style="padding-left:10px; font-size: 16px; "><img src="images/blocks.gif" width="20" height="20" align="absmiddle" /> 毛豆管理系统</span>
</div>
